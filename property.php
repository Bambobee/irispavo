...
$idx = end($parts);
$row = dbRow("SELECT * FROM property_type WHERE property_type_id = '$idx' "); 
$all_properties = $dbh->query("SELECT * FROM properties p, property_type pt, property_category pc, users u WHERE p.category_id = pc.category_id AND p.property_type_id = pt.property_type_id AND p.user_id = u.user_id AND pt.property_type_id = '".$row->property_type_id."' ");
?>
<!-- Property List Start -->
<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    <h1 class="mb-3">Property Type: <b class="text-primary"><?=ucwords($row->property_type_name); ?></b></h1>
                </div>
            </div>
        </div>
        <div class="tab-content">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="property-item rounded overflow-hidden">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3"><?=ucwords($rx->category_name); ?></div>
                            </div>
                            <div class="p-4 pb-0">
            ...
            <?php }else{ ?>
                <div class="alert alert-danger text-center">No Property Type under <b>[<?=ucwords($row->property_type_name); ?>]</b> Found !</div>
            <?php } ?>
            </div>
