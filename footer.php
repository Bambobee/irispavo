        ...
        <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5">
                ...
                <div class="icon p-2 me-2" style="border: 2px dashed #fff !important; background: transparent !important; ">
                        <img class="img-fluid" src="img/logo.png" alt="Icon" style="width: 100%; height: 100%;">
                    </div>
                </div>
                    <div class="col-lg-4 col-md-6">
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="http://localhost/real_estate/index.php">IRIS PAVO</a>, All Right Reserved. 
							
							
							Designed By <a class="border-bottom" href="https://freewebsitecode.com">OSP Digital solutions</a>
                        </div>
