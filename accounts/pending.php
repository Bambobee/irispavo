  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <!-- Button trigger modal -->
          ...
          <?php $user = $dbh->query("SELECT * FROM users WHERE usergroup != 'Admin' && verification = 'Pending' ");
        if ($user->rowCount() > 0) {
          $SN = 1;  ?>
            <thead>
              <tr>
            ...
            <?php while ($rx = $user->fetch(PDO::FETCH_OBJ)) { ?>
              <tr>
                ...
                <td><?=$rx->email; ?></td>
                <td><?=$rx->usergroup; ?></td>
                <td><span class="badge bg-info"><?=$rx->verification; ?></span></td>
                <td>
                <div class="dropdown">
