...
switch(DB_URL){
	...
	case 'localhost':
		...
		defined ("DB_NAME") or define("DB_NAME", "realestate");
		defined ("SITE_URL") or define("SITE_URL", 'http://localhost/irispavo/');
		defined ("HOME_URL") or define("HOME_URL", 'http://localhost/irispavo/accounts/');
	break;

	//online url
	case 'https://dapucharity.org': 
		defined ("DB_SERVER") or define("DB_SERVER", "localhost");
		defined ("DB_USER") or define("DB_USER", "");
		defined ("DB_PASS") or define("DB_PASS", "");
		defined ("DB_NAME") or define("DB_NAME", "");
		defined ("SITE_URL") or define("SITE_URL", 'https://irispavo.com/');
		defined ("HOME_URL") or define("HOME_URL", 'https://irispavo.com/accounts/');
	break;
...
function yoolasms_api($phone, $message){
	$arr = array(
	"api_key" => "FGVGen2D6o8Zg7iTTWzomO0jq0QJn3L19e02JvfCQ3CVP2yTO3SCJ7w2E0s82WOd",
    "phone" => $phone,
    "message" => $message
	);
